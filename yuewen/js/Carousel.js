	...
	var Carousel = (function(){
		...
		Carousel.prototype = {
			...
			init:function(){
				...
				me.posterItemMain = me.poster.find("ul.ywBookShow-ul");
				//me.posterItems = me.posterItemMain.find("li.poster-item");
				me.posterItems = me.posterItemMain.find("img.yw-book-pic");	
				me.posterItems.size=()=>{ return me.posterItems.length;}
			...
			setPosterPost:function(){
				...
				var sliceItems = me.posterItems.slice(1);
					sliceItems.size=()=>{return sliceItems.length}
